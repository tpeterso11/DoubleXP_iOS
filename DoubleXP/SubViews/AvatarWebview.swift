...
class AvatarWebview: UIViewController, WKScriptMessageHandler {
    ...
    override func viewDidLoad() {
        ...
        self.reloadPage(clearHistory: true)
    }
    ...
    func reloadPage(clearHistory : Bool){
        let url = URL(string: "https://doublexp.readyplayer.me/avatar?frameApi")!
        if(clearHistory){
